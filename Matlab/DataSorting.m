...
figure(1)
plot(FSS_Together(1:5500))
hold on
plot(Data_i.HCmotor(1:5500)*0.18)
...
for i = Initial:Final
    ...
    if(Data_i.HCmotor(i)==1)
        text(6, 0.007, 'Ground Truth: Slip', 'Color', 'red', 'FontSize', 20)
    else
        text(6, 0.007, 'Ground Truth: No Slip', 'FontSize', 20)
    end
end
